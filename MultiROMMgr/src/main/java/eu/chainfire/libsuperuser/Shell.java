...
public class Shell {    
    ...
    public static class SU {
        ...
        public static String version(boolean internal) {
            ...
            Debug.logCommand(String.format("Line from version!"));
            if (ret == null) return null;

            for (String line : ret) {
                Debug.logCommand(String.format("Line from versions: %s", line));
                if (!internal) {
         ...
         */
        private static int is_enforcing = -1;
        public static String shell(int uid, String context) {
            ...
            if (is_enforcing == -1 && (context != null) && (android.os.Build.VERSION.SDK_INT >= 17)) {
            ...
            if (is_enforcing == 1) {
                ...
                Debug.logCommand(String.format("creating shell cmd, versions: %s %s", display, internal));
            }
            ...
            Debug.logCommand(String.format("Using shell enforcing %d, %s", is_enforcing, shell));
            return shell;
        }
